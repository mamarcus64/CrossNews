...
#################################
def resample_pairs_train(model_folder, file_results):

    with open(os.path.join(model_folder, "data_preprocessed",  'dict_author_fandom_doc_train_tokenized'), 'rb') as f:
