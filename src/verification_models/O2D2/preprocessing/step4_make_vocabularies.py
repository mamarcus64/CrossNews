...
# need to download manually from here: https://fasttext.cc/docs/en/crawl-vectors.html, then update this variable accordingly
PATH_TO_CC_BINARY = 'src/verification_models/O2D2/cc.en.300.bin'
...
def run(model_folder):
    ...
    ################################################
    WE_dic = fasttext.load_model(PATH_TO_CC_BINARY)
