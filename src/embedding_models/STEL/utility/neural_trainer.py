...
from embedding_models.STEL.global_const import set_global_seed, SEED
...
from embedding_models.STEL.global_identifiable import STRANFORMERS_CACHE
from embedding_models.STEL.global_const import SUBREDDIT_U2_COL, SUBREDDIT_U1_COL, SUBREDDIT_A_COL, CONVERSATION_U2_COL, \
    CONVERSATION_U1_COL, CONVERSATION_A_COL, ID_U2_COL, ID_U1_COL, ID_A_COL, AUTHOR_U2_COL, AUTHOR_U1_COL, AUTHOR_A_COL

from embedding_models.STEL.utility.training_const import TRIPLET_EVALUATOR, BINARY_EVALUATOR, TRIPLET_LOSS, CONTRASTIVE_ONLINE_LOSS, \
...
class SentenceBertFineTuner:
    ...
    def __init__(self, train_filename, dev_filename, model_path='distilbert-base-nli-stsb-mean-tokens',
                 ...
                 evaluation_type=BINARY_EVALUATOR, debug=False, seed=SEED, save_folder=None, save_every=1):
        """
    ...
    def train(self, epochs=EPOCHS, batch_size=BATCH_SIZE, warmup_steps=WARMUP_STEPS, evaluation_steps=EVALUATION_STEPS,
        ...
        self.model.fit(train_objectives=[(train_dataloader, train_loss)],
                    ...
                    #    evaluation_steps=evaluation_steps,
                       ...
                       checkpoint_save_steps=self.save_every,
                       checkpoint_path=self.save_folder,
    ...
    def get_input_examples(task_filename, is_eval_task=False, as_float=True, loss=CONTRASTIVE_LOSS,
        ...
        :return:
        """
        from embedding_models.STEL.utility.convokit_generator import ANCHOR_COL, U1_COL, U2_COL, SAME_AUTHOR_AU1_COL
        train_examples = []
