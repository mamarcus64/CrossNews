...
from embedding_models.LUAR.utilities import decorators as decorator
...
class Utils(object):
    ...
    def __init__(self):
        ...
        self.config_filename = 'embedding_models/LUAR/file_config.ini'
    ...
    def set_paths(self):
        ...
        Experiment_Paths = {
            'project_root_path': 'embedding_models/LUAR',
            'output_path': 'embedding_models/LUAR/output',
            'data_path': '.',
            'transformer_path': 'sentence-transformers'
        }
